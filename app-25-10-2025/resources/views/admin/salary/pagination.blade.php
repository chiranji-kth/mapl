<div class="table-responsive">
    <table class="table table-hover manage-u-table" id="example">
        ...
        <tbody>
            ...
            $pf_amount_employee = $pf_applicable > 0 ? round(0.12 * $gross, 2) : 0;
            $esi_amount_employee = $esi_applicable > 0 ? round(0.0175 * $gross, 2) : 0;
            
            $pf_amount_employer = $pf_applicable > 0 ? round(0.12 * $gross, 2) : 0;
            $esi_amount_employer = $esi_applicable > 0 ? round(0.0475 * $gross, 2) : 0;
