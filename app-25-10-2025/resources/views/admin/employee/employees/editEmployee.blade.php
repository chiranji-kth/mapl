            ...
            <div class="panel panel-info">
                ...
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                        {{ Form::model($empModeData, ['route' => ['employees.update', $empModeData->emp_id], 'method' => 'PUT', 'files' => 'true', 'class' => ' ajaxFormSubmit', 'id' => 'employeeForm', 'data-redirect' => route('employees.index')]) }}
                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <label for="exampleInput">Aadhar<span
                                        ...
                                        <div class="input-group">
                                            <input class="form-control number aadhar" id="phone" placeholder="Aadhar" name="aadhar" type="text"
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control date_of_joining dateField date" readonly
                                            ...
                                            value="{{ $empModeData->date_of_joining }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
