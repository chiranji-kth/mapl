...
<div class="container-fluid">
	<div class="row bg-title">
		...
		<div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
			<a href="{{route('payroll.salarys')}}"  class="btn btn-success pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light">
				<i class="fa fa-list-ul" aria-hidden="true"></i>  View Salarys</a>
		</div>
	</div>
	<div class="row">
		<div class="col-md-12">
			<div class="panel panel-info">
				...
				<div class="panel-wrapper collapse in" aria-expanded="true">
					<div class="panel-body">
						...
						@endif
						{{ Form::open(array('route' => 'payroll.calculateEmployeeSalary','method'=>'GET','id'=>'calculateEmployeeSalaryForm')) }}
						<div class="form-body">
							<div class="row">
								<div class="col-md-4">
							...
							<div class="row">
								<div class="col-md-4">
									<label for="exampleInput">Working Days<span class="validateRq">*</span></label>
									<div class="input-group">
										<input class="form-control required" id="days" placeholder="days" name="days" type="number">
									</div>
								</div>
								<div class="col-md-4">
                                ...
                                <div class="col-md-4">
									<label for="exampleInput">Advance Amount<span class="validateRq">*</span></label>
									<div class="input-group">
										<input class="form-control required" id="advance" placeholder="advance" name="advance" type="number">
									</div>
								</div>
							</div>
							<div class="row">
								...
								<div class="col-md-4">
									<label for="exampleInput">wages per  Day<span class="validateRq">*</span></label>
									<div class="input-group">
										<input class="form-control required" id="wages" placeholder="wages per day" name="wages" type="number">
									</div>
								</div>
							    <div class="col-md-4">
									<label for="exampleInput">Dress Amount<span class="validateRq">*</span></label>
									<div class="input-group">
										<input class="form-control required" id="dress" placeholder="dress amount" name="dress" type="number">
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
