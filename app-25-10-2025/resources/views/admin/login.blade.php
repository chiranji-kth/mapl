...
<body>
    ...
    <section id="wrapper" class="loginScr">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="white-box">
                        ...
                        <div class="form-group text-center m-t-20">
                            <div class="col-xs-12">
                                <button class="btn btnLogin btn-lg btn-block text-uppercase waves-effect waves-light"
        ...
        <div class="bg-white loginFooter text-center">
            <p>Copyright © <script>document.write(new Date().getFullYear())</script>2024 Security Guard. All Rights Reserved by
