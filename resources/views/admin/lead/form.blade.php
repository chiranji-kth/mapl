            ...
            <div class="panel panel-info">
                ...
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                        {{ Form::open(['route' => 'lead.store', 'enctype' => 'multipart/form-data', 'class' => 'ajaxFormSubmit', 'id' => 'leadForm', 'data-redirect' => route('lead.index')]) }}
                        <div class="form-body">
                            <div class="row">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control required phone" required id="phone"
                                            placeholder="Phone" name="phone" type="text">
                                    </div>
                                </div>
                                <div class="col-md-4">
