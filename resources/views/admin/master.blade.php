...
<head>
    ...
    <style>
        ...
        .breadcrumbColor a {
            color: rgba(159, 10, 18, 0.9) !important;
        }
...
<body class="fix-header" onload="addMenuClass()">
    ...
    <div id="wrapper">
                    ...
                    <li class="dropdown">
                        ...
                        ?>
                            <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"> <img
                                    ...
                                    class="hidden-xs ">{!! $employeeInfo[0]->user_name !!}</b><span
                                    class="caret"></span>
                            </a>
                        <?php } else { ?>
                            <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"> <img
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li class="treeview waves-effect">
                        <a href="javascript:void(0)" class="module">
                            ...
                            <span class="hide-menu hideMenu">&nbsp;Branches
                                <span class="fa arrow"></span>
                            </span>
                        </a>
                        <ul class="treeview-menu nav nav-second-level">

                            <li><a href="<?= route('branch.index'); ?>"><i data-icon="/" class="linea-icon linea-basic fa-fw"></i><span class="hideMenu">Branch</span></a></li>
                    ...
                    <li class="treeview waves-effect">
                        <a href="javascript:void(0)" class="module">
                            <i class="iconFontSize mdi mdi-home hideMenu"></i>
                            <span class="hide-menu hideMenu">&nbsp;Job/Post
                                <span class="fa arrow"></span>
                            </span>
                        </a>
                        <ul class="treeview-menu nav nav-second-level">

                            <li><a href="<?= route('jobPost.index'); ?>"><i data-icon="/" class="linea-icon linea-basic fa-fw"></i><span class="hideMenu">Job/Post</span></a></li>
                    ...
                    <li class="treeview waves-effect">
                        <a href="javascript:void(0)" class="module">
                            <i class="iconFontSize mdi mdi-home hideMenu"></i>
                            <span class="hide-menu hideMenu">&nbsp;Company
                                <span class="fa arrow"></span>
                            </span>
                        </a>
                        <ul class="treeview-menu nav nav-second-level">

                            <li><a href="<?= route('company.index'); ?>"><i data-icon="/" class="linea-icon linea-basic fa-fw"></i><span class="hideMenu">Company</span></a></li>
                    ...
                    <li class="treeview waves-effect">
                        <a href="javascript:void(0)" class="module">
                            <i class="iconFontSize mdi mdi-account-multiple-plus hideMenu"></i>
                            <span class="hide-menu hideMenu">&nbsp;Employee
                                <span class="fa arrow"></span>
                            </span>
                        </a>
                        <ul class="treeview-menu nav nav-second-level">
                    ...
                    <li class="treeview waves-effect">
                        <a href="javascript:void(0)" class="module">
                            <i class="iconFontSize mdi mdi-home hideMenu"></i>
                            <span class="hide-menu hideMenu">&nbsp;Quotation/Invoice
                                <span class="fa arrow"></span>
                            </span>
                        </a>
                        <ul class="treeview-menu nav nav-second-level">

                            <li><a href="<?= route('quotation.index'); ?>"><i data-icon="/" class="linea-icon linea-basic fa-fw"></i><span class="hideMenu">Quotation</span></a></li>
                            <li><a href="<?= route('invoice.index'); ?>"><i data-icon="/" class="linea-icon linea-basic fa-fw"></i><span class="hideMenu">Invoice</span></a></li>
        ...
        <footer class="footer text-center">
            {{ date('Y') }} &copy;Security Guard All Rights Reserved. Powered By <strong> <a href="https://kriscent.in"
                    target="_blank" class="text-red">Kriscent Techno Hub Pvt. Ltd.</a>
            </strong>
        </footer>
    </div>
