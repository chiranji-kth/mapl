							...
							<div class="">
								...
								<div class="col-xs-6 col-sm-6 col-md-3">
									<div class="applicant_pic text-right">
										...
										if ($result->kyc_file != '') {
										?>
											<img style="width: 124px;height:135px" src="{!! asset('uploads/employeePhoto/'.$result->kyc_file) !!}">
										<?php  } else { ?>
											<img style="width: 124px;height:135px" src="{!! asset('admin_assets/img/default.png') !!}">
										<?php } ?>

										<h5>{{$result->kyc_doc}}</h5>
									</div>
									<br>
								</div>
								...
								<div class="personal_info">
									...
									<div class="row">
										<div class="personal_info">
											...
											<div class="item">
												<div class="col-xs-2 col-sm-2 col-md-3">Acc/no</div>
												<div class="col-xs-10 col-sm-10 col-md-9">:&nbsp;&nbsp;&nbsp;&nbsp;{{$result->acc_no}}</div>
											</div>
											<div class="item">
												<div class="col-xs-2 col-sm-2 col-md-3">IFSC Code</div>
											...
											<div class="item">
												<div class="col-xs-2 col-sm-2 col-md-3">NOMINEE NAME</div>
											...
											<div class="item">
												<div class="col-xs-2 col-sm-2 col-md-3">Salary Expectations</div>
