                                ...
                                <tbody>
                                    ...
                                    <tr class="{!! $value->job_id !!}">
                                        ...
                                        <!-- <td>
                                            ...
                                            @endif
                                            <br /><span class="text-muted">Published Date:
                                        ...
                                        <td>
                                            <span
                                                class="label label-{{ $value->status == '1' ? 'success' : 'warning' }}">{{ $value->status == '1' ? __('recruitement.published') : __('recruitement.unpublished') }}</span>
                                        </td>
                                        <td style="width: 100px;">
                                            ...
                                            <a href="{!! route('jobPost.delete', $value->job_id) !!}"
