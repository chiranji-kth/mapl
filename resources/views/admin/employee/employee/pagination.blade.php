        ...
        <tbody>
            ...
            <tr class="{!! $value->employee_id !!}">
                ...
                <td>
                    ...
                    <a href="{!! route('employee.show', $value->employee_id) !!}"><img style=" width: 70px; " src="{!! asset('uploads/employeePhoto/' . $value->photo) !!}"
                            alt="user-img" class="img-circle"></a>
                    @else
                    <a href="{!! route('employee.show', $value->employee_id) !!}"> <img style=" width: 70px; " src="{!! asset('admin_assets/img/default.png') !!}"
                            alt="user-img" class="img-circle"></a>
                    @endif
                </td>
                <td>
                ...
                <td>
                    ...
                    <br /> -->
                    <span class="text-medium">@lang('employee.designation') :
