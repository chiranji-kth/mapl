            ...
            <div class="panel panel-info">
                ...
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                        {{ Form::open(['route' => 'employee.store', 'enctype' => 'multipart/form-data', 'class' => 'ajaxFormSubmit', 'id' => 'employeeForm', 'data-redirect' => route('employee.index')]) }}
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="exampleInput">Assign @lang('employee.role')<span
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <label for="exampleInput">@lang('employee.kyc_doc')<span class="validateRq">*</span></label>
                                    <div class="input-group">
