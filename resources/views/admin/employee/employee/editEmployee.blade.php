            ...
            <div class="panel panel-info">
                ...
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                        {{ Form::model($editModeData, ['route' => ['employee.update', $editModeData->employee_id], 'method' => 'PUT', 'files' => 'true', 'class' => ' ajaxFormSubmit', 'id' => 'employeeForm', 'data-redirect' => route('employee.index')]) }}
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select name="kyc_doc" id="kyc_doc" class="form-control kyc_doc required select2">
                                            <option value="">--- @lang('common.please_select') ---</option>
                                            <option value="Aadhar Card" <?= ($editModeData->kyc_doc == 'Aadhar Card') ? 'selected' : '' ?>>Aadhar Card</option>
                                            <option value="Voter ID" <?= ($editModeData->kyc_doc == 'Voter ID') ? 'selected' : '' ?>>Voter ID</option>
                                            <option value="PAN Card" <?= ($editModeData->kyc_doc == 'PAN Card') ? 'selected' : '' ?>>PAN Card</option>
                                            <option value="Bank Passbook" <?= ($editModeData->kyc_doc == 'Bank Passbook') ? 'selected' : '' ?>>Bank Passbook</option>
                                            <option value="Driver License" <?= ($editModeData->kyc_doc == 'Driver License') ? 'selected' : '' ?>>Driver License</option>
                                            <option value="Other" <?= ($editModeData->kyc_doc == 'Other') ? 'selected' : '' ?>>Other</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-3">
