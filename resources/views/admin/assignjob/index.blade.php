...
<div class="container-fluid">
	<div class="row bg-title">
		...
		<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
			...
			@if(request()->routeIs('assignJob.index'))
			{{-- We are on the index (active records) page --}}
			<a href="{{ route('assignJob.inactive') }}"
				class="btn btn-danger pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light">
				<i class="fa fa-ban" aria-hidden="true"></i> Deactive Record
			</a>
			@elseif(request()->routeIs('assignJob.inactive'))
			{{-- We are on the inactive (deactivated records) page --}}
			<a href="{{ route('assignJob.index') }}"
				class="btn btn-danger pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light">
				<i class="fa fa-check-circle" aria-hidden="true"></i> Active Record
			</a>
			@endif
		...
		<div class="col-sm-12">
			<div class="panel panel-info">
				<div class="panel-heading">
					<i class="mdi mdi-table fa-fw"></i> Assign Job
					<span class="text-success">
						{{ request()->routeIs('assignJob.index') ? 'Active Record' : 'Deactive Record' }}
					</span>
				</div>
