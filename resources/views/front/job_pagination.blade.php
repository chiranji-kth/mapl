                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="text-left">
                                                        ...
                                                        class="btn btn-primary">View Details<i class="mdi mdi-chevron-double-right"></i></a>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="text-right">
                                                        <a href="{{ route('job.details',['id' => $job->job_id,'slug' => str_replace(' ','-',strtolower($job->job_title))]) }}" class="btn btn-primary ">Apply Now <i class="mdi mdi-chevron-double-right"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
